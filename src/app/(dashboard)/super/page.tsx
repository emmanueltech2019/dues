...
import { cards, cards2, statList, todayAbsent, invoice, payment, clients, recentProjects } from './components/AdminObj';
   ...
   return (
      <div className="p-[30px]">
         <header className="text-[#bbc4cc]">
            <h2 className=" text-lg font-semibold">Welcome Super Admin!</h2>
